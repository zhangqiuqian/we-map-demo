...
var ProjectionTransform = {
  ...
  _transformGeoJSON: function (geoJSON, fromCRS, toCRS) {
    if (geoJSON['type'] === 'Feature') {
      ...
      let result = this._extend({}, geoJSON)
  ...
  _extend: function (src, dst) {
    for (var p in dst) {
      if (Object.hasOwnProperty.call(dst, p)) {
        src[p] = dst[p]
      }
    }
    return src
  ...
  _isArray: function (obj) {
    ...
    return (typeof obj === 'object' && obj.length) || (obj.constructor !== null && obj.constructor == Array)
  },
